...
class SridChangeHikingRoutes2Test extends TestCase
{
    ...
    public function get_single_hiking_route_api_returns_correct_geometry_4326()
    {
        ...
        $this->response = $this->get('/api/v1/features/hiking-routes/R4486120'); //https://www.openstreetmap.org/relation/4486120
        ...
        $geojsonPath = storage_path('tests/valle_delle_fonti.geojson');
