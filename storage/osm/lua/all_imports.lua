...
function process_place(object, geom)
    ...
    -- mapping of OSM tags to our feature internal representation
       local mappings= {
            ...
            { key = 'historic', values = { wayside_shrine = 'wayside_shrine', wayside_cross = 'wayside_cross', monastery = 'monastery', archaeological_site = 'archaeological_site', castle = 'castle', farm = 'farm', fort = 'fort', manor = 'manor', tower = 'tower', city_gate = 'city_gate', church = 'church', ruins = 'ruins'}, class = 'historic' },
